...
static NSString * const ShareURL = @"http://xxxxx.stg.aaa.com/app/share";
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    NSLog(@"self.webView.URL=%@",self.webView.URL);
    ...
    if (self.webView.URL == nil){
        ...
        if (![pageurl isEqualToString:ShareURL]) {
            [self loadSharePage];
        }
...
-(void)loadSharePage{
    ...
    NSString *ustr = [NSString stringWithFormat:@"%@",[IMLAPIClient makeLoadableURLString:ShareURL]];
